 ...
 function afl_add_new_customer_form () {
	$obje = new Afl_enque_scripts('eps-add-new-member');
 	...
 	if ( isset($_POST['submit'] ) ) {
        $rules = create_customer_validation_rules($_POST);
	        ...
	        $user_uid = complete_customer_registration(
		        $username,
		        $password,
		        $email,
		        $first_name,
 	...
 	afl_add_new_customer_form_callback($post);
 }
/*
 * ---------------------------------------------
 * Add new member Form
 * ---------------------------------------------
*/
 function afl_add_new_customer_form_callback ($post) {
 	// pr(get_users());
...
function complete_customer_registration($username, $password, $email, $first_name, $sur_name, $sponsor) {
 ...
 * ---------------------------------------------
*/
	function create_customer_validation_rules ($POST) {
		$rules = array();
			 	$rules[] = array(
